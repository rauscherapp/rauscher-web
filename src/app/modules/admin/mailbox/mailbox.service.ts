...
export class MailboxService
{
    ...
    {
        return this._httpClient.get<MailFilter[]>('api/mailbox/filters').pipe(
            tap((response: any) =>
            {
    ...
    {
        return this._httpClient.get<MailFolder[]>('api/mailbox/folders').pipe(
            tap((response: any) =>
            {
    ...
    {
        return this._httpClient.get<MailLabel[]>('api/mailbox/labels').pipe(
            tap((response: any) =>
            {
    ...
    getMailsByFilter(filter: string, page: string = '1'): Observable<any>
    {
        ...
        return this._httpClient.get<Mail[]>('api/mailbox/mails', {
            params: {
                filter,
                page,
            },
    ...
    {
        return this._httpClient.patch('api/mailbox/mail', {
            id,
            mail,
        }).pipe(
            tap(() =>
    ...
    addLabel(label: MailLabel): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.post<MailLabel>('api/mailbox/label', {label}).pipe(
                map((newLabel) =>
                {
    ...
    updateLabel(id: string, label: MailLabel): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.patch<MailLabel>('api/mailbox/label', {
                id,
                label,
            }).pipe(
    ...
    deleteLabel(id: string): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.delete('api/mailbox/label', {params: {id}}).pipe(
                map((isDeleted: any) =>
                {
